...
router.put('/:userId', user_middleware_1.userMiddleware.isUserIdValid, user_middleware_1.userMiddleware.isUserValidUpdate, user_middleware_1.userMiddleware.getByIdAndThrow, user_controller_1.userController.update);
